  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(path: '/manager/jobs/:jobId/applicants', builder: (context, state) { final jobId = state.pathParameters['jobId']!; final jobTitle = state.extra as String?; return BlocProvider(create: (context) => JobApplicantsBloc(context.read<ApplicationRepository>())..add(LoadJobApplicants(jobId)), child: JobApplicantsScreen(jobId: jobId, jobTitle: jobTitle)); }),
