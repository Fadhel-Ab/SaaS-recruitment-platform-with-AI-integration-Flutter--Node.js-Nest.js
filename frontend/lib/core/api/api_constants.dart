class ApiConstants {
  ...
  //static const String baseUrl ="https://saas-recruitment-platform-with-ai-integration-fl-production.up.railway.app/api";
  ...
  static String get serverOrigin => baseUrl.endsWith('/api')
